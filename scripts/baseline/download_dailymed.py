...
Usage:
    ...
    python scripts/baseline/download_dailymed.py
    
    # Or specify custom path
    python scripts/baseline/download_dailymed.py --output-dir /data/ingestion/dailymed/xml
    
    # Weekly incremental update (recommended for monthly refresh)
    python scripts/baseline/download_dailymed.py --update-type weekly
...
Examples:
  ...
  python scripts/baseline/download_dailymed.py --update-type weekly --weeks-back 4
  
  # Daily updates (last 7 days)
  python scripts/baseline/download_dailymed.py --update-type daily
  
  # Monthly update
  python scripts/baseline/download_dailymed.py --update-type monthly
        """
    )
    parser.add_argument(
        "--output-dir",
