...
def extract_article_data(
    ...
    min_year: int,
    apply_publication_type_filter: bool = True,
    apply_abstract_text_filter: bool = True,
) -> Optional[Dict]:
    """
    ...
    try:
        ...
        if apply_publication_type_filter and not is_target_article(pub_types):
            return None
        ...
        if apply_abstract_text_filter and (not abstract_text or len(abstract_text) < 50):
            return None
        ...
        article_type = map_publication_type(pub_types) or "journal_article"
